...
//Nom du Pays à partir du Code Alpha 3
function code3FromName($name)
{
    foreach (getCountries() as [$numerique, $alpha2, $alpha3, $nom]) {
        if ($name === $nom) {
            return $alpha3;
        }
    }
...
//Nom du Pays à partir du Code Alpha 2
function code2FromName($name)
{
    foreach (getCountries() as [$numerique, $alpha2, $alpha3, $nom]) {
        if ($name === $nom) {
            return $alpha2;
...
//Nom du Pays à partir du Code Numerique
function numericalFromName($name)
{
    foreach (getCountries() as [$numerique, $alpha2, $alpha3, $nom]) {
        if ($name === $nom) {
            return $numerique;
...
//Code Alpha 3 à partir du Nom
function nameFromCode3($code3){
    foreach (getCountries() as [$numerique, $alpha2, $alpha3, $nom]) {
        if ($code3 === $alpha3) {
            return $nom;
        }
...
//Code Alpha 2 à partir du Nom
function nameFromCode2($code2){
    foreach (getCountries() as [$numerique, $alpha2, $alpha3, $nom]) {
        if ($code2 === $alpha2) {
            return $nom;
        }
